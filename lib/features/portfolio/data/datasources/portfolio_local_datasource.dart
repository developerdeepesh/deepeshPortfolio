...
class PortfolioLocalDataSourceImpl implements PortfolioLocalDataSource {
  ...
  List<ProjectModel> getProjects() => [
    ...
    const ProjectModel(
      ...
      technologies: ['Flutter', 'Dart', 'Geospatial', 'REST APIs'],
      imageUrl: 'https://picsum.photos/seed/naksha/600/400',
      playStoreUrl: 'https://play.google.com/store/apps/details?id=com.dolr.naksha',
      isFeatured: true,
    ),
    const ProjectModel(
      id: '2',
      ...
      technologies: ['Flutter', 'Dart', 'Android', 'iOS', 'REST APIs'],
      imageUrl: 'https://picsum.photos/seed/dwrs/600/400',
      playStoreUrl: 'https://play.google.com/store/apps/details?id=com.mapit.sderf',
    ...
    const ProjectModel(
      ...
      technologies: ['Flutter', 'Dart', 'Maps', 'Real-time', 'Android', 'iOS'],
      imageUrl: 'https://picsum.photos/seed/mahakumbh/600/400',
      playStoreUrl: 'https://play.google.com/store/apps/details?id=com.mobile.mahakumbh',
      appStoreUrl: 'https://apps.apple.com/in/app/ujjainmahakumbh2028/id6756865608',
      isFeatured: true,
    ),
    const ProjectModel(
      id: '4',
      ...
      appStoreUrl: ' https://apps.apple.com/al/app/imobile-loan-cards-banking/id375276006',
    ),
    const ProjectModel(
      id: '5',
      title: 'Mobipetz',
  ...
  List<SkillEntity> getSkills() => const [
        ...
        // Backend & APIs
        SkillEntity(name: 'RESTful APIs', proficiency: 0.92, category: 'Backend & APIs'),
        SkillEntity(name: 'SQLite / SQL', proficiency: 0.82, category: 'Backend & APIs'),
        SkillEntity(name: 'JSON', proficiency: 0.95, category: 'Backend & APIs'),
        // Tools & Platforms
        SkillEntity(name: 'Git / Version Control', proficiency: 0.92, category: 'Tools'),
        ...
        SkillEntity(name: 'Visual Studio / Cursor', proficiency: 0.85, category: 'Tools'),
      ];
